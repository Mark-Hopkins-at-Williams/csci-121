class TreeNode:
    ...
    def __contains__(self, lbl):
        if self.label() == lbl:
            return True
        elif self.left() != None and lbl in self.left():
            return True
        elif self.right() != None and lbl in self.right():
            return True
        else:
            return False
    ...
    def __eq__(self, node):
        if node == None:
            ...
            same_label = self.label() == node.label()
            same_left = self.left() == node.left()
            same_right = self.right() == node.right()
            return same_label and same_left and same_right
